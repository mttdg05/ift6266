...
if __name__ == '__main__'  :
  ...
  # compute the encoder
  alpha = 0.005
  whiten_patches = np.load('data/whiten/test/test_whiten_patches0.npy')
  centers = np.load('data/centers.npy') 
  whiten_patches = whiten_patches[ 909708 : 1212944 ].copy()
  ...
  np.save( "data/pooled_features/test/test_pooled_features3.npy", pooled_features )
