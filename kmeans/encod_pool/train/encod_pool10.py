...
if __name__ == '__main__'  :
  ...
  # compute the encoder
  alpha = 0.005
  whiten_patches = np.load('data/whiten/train/train_whiten_patches2.npy')
  centers = np.load('data/centers.npy') 
  whiten_patches = whiten_patches[ 924500 : 1386750 ].copy()
  ...
  np.save( "data/pooled_features/train/train_pooled_features10.npy", pooled_features )
