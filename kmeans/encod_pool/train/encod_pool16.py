...
if __name__ == '__main__'  :
  ...
  # compute the encoder
  alpha = 0.005
  whiten_patches = np.load('data/whiten/train/train_whiten_patches3.npy')
  centers = np.load('data/centers.npy') 
  whiten_patches = whiten_patches[ 1849000 : 2178122 ].copy()
  ...
  np.save( "data/pooled_features/train/train_pooled_features16.npy", pooled_features )
